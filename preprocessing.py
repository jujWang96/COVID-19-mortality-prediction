...
file_path = './covid_case_restricted_detailed-master/data/CA_combined_csv.csv'
...
#add features
df_add = add_feature(df,'income_race.csv',['race_ethnicity_combined','res_county'])
...
df_encoded.to_csv(r'./CA_cleaned.csv',index = False)
